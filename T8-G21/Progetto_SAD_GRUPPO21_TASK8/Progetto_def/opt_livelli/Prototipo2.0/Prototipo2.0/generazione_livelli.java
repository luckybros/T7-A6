	...
	public static void main(String[] args) {
		...
		try {
			...
			ProcessBuilder processBuilder = new ProcessBuilder("bash", scriptPath,
					vet_key.get(Return.elementAt(0)).toString(), vet_key.get(Return.elementAt(1)).toString(),
					vet_key.get(Return.elementAt(2)).toString(), vet_key.get(Return.elementAt(3)).toString(),
					vet_key.get(Return.elementAt(4)).toString(), vet_key.get(Return.elementAt(5)).toString(),
					vet_key.get(Return.elementAt(6)).toString(),
					vet_key.get(Return.elementAt(7)).toString(), vet_key.get(Return.elementAt(8)).toString(),
					vet_key.get(Return.elementAt(9)).toString(), vet_key.get(Return.elementAt(10)).toString(),
